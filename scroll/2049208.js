...
function start(equip) {
    ...
    if(equip.getWdef() > 0) {
        equip.setWdef(equip.getWdef()+cm.getRandom(0, attr)+fixAttr);
    }
    ...
    if(equip.getMdef() > 0) {
        equip.setMdef(equip.getMdef()+cm.getRandom(0, attr)+fixAttr);
    }

    if(equip.getAcc() > 0) {
        equip.setAcc(equip.getAcc()+cm.getRandom(0, attr)+fixAttr);
    }

    if(equip.getAvoid() > 0) {
        equip.setAvoid(equip.getAvoid()+cm.getRandom(0, attr)+fixAttr);
    }

    if(equip.getSpeed() > 0) {
        equip.setSpeed(equip.getSpeed()+cm.getRandom(0, attr)+fixAttr);
    }

    if(equip.getJump() > 0) {
        equip.setJump(equip.getJump()+cm.getRandom(0, attr)+fixAttr);
    }
