...
function start(equip) {
    ...
    var MatkRise = 0;
          ...
          if(MatkRandom >=  1 && MatkRandom <=  35){MatkRise = 15
    }else if(MatkRandom >= 36 && MatkRandom <=  65){MatkRise = 16
    }else if(MatkRandom >= 66 && MatkRandom <=  80){MatkRise = 17
    }else if(MatkRandom >= 81 && MatkRandom <=  88){MatkRise = 18
    }else if(MatkRandom >= 89 && MatkRandom <=  95){MatkRise = 19
    }else if(MatkRandom >= 96 && MatkRandom <= 100){MatkRise = 20
    }
