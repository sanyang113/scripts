...
function start(mode, type, selection) {
	...
	qm.askAcceptDecline("啊！ 既然您是英雄 ，只要揮揮劍應該會想起什麼吧！您想不想去#b獵捕怪物#k呢?");
    } else if (status == 3) {
	qm.forceStartQuest();
	qm.sendNext("正好這附近有很多 #r#o9300383#s#k 請您去擊退 #r3隻#k。	搞不好會想起些什麼。");
    } else if (status == 4) {
	qm.sendNextPrevS("啊，該不會連技能使用方法都忘光了吧？ #b將技能放入快捷欄就可以輕鬆使用#k。 不只是技能，連消耗道具也可以放進去，請多加利用。", 1);
    } else if (status == 5) {
	qm.summonMsg(17);
	qm.dispose();
    }
...
function end(mode, type, selection) {
    ...
    if (status == 0) {
	qm.sendYesNo("嗯...看您的表情，似乎什麼都沒有想起來...可是請不要擔心。總有一天會好起來的。來，請您喝下這些藥水打起精神來: \r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0# \r\n#i2000022# 10 #t2000022# \r\n#i2000023# 10 #t2000023# \r\n\r\n#fUI/UIWindow.img/QuestIcon/8/0# 57 經驗值");
    } else if (status == 1) {
