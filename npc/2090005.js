...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.getMapId() == 251000000) {
            cm.sendYesNo("怎麼樣？我從 " + btwmsg + " 再到這裡。我的速度很快的吧，如果你想返回 #b" + menu[3] + "#k ，那麼我們就立刻出發，不過還是得給我一些辛苦錢，價格是 #b" + cost[3] + " 楓幣#k。");
        } else {
            cm.sendSimple("如果想從 " + btwmsg + " 去的話。給我些辛苦錢就送你一趟。我送你比起你走著去快多了。怎麼樣？\r\n" + display);
        }
    } else if (status == 1) {
        sel = selection;
        if (selection == 2) {
            ...
            if(cm.getMapId() == 250000100) {
                cm.sendSimple("#b#L99#我想讓你慢慢載我飛#l\r\n#b#L100#我想直接抵達天空之城#l");
            } else {
                cm.sendSimple("#b#L99#我想讓你慢慢載我飛#l\r\n#b#L100#我想直接抵達桃花仙境#l");
            }
