...
var itemList = new Array(
    2040502, 2040505, 2040802, 2040002, 2040402, 2040602, //卷軸
    2040502, 2040505, 2040802, 2040002, 2040402, 2040602, //卷軸
    2040502, 2040505, 2040802, 2040002, 2040402, 2040602, //卷軸
    1032004, 1032005, 1032009, 1032006, 1032007, 1032010, 1032002, 1002026, 1002089, 1002090, //裝備
    1032004, 1032005, 1032009, 1032006, 1032007, 1032010, 1032002, 1002026, 1002089, 1002090, //裝備
    2000001, 2000002, 2000003, 2000006, 2000004, 2022000, 2022003, //藥水
    2000001, 2000002, 2000003, 2000006, 2000004, 2022000, 2022003, //藥水
    2000001, 2000002, 2000003, 2000006, 2000004, 2022000, 2022003, //藥水
    4010000, 4010001, 4010002, 4010003, 4020007, 4020008, 4003000, //礦石
    4010004, 4010005, 4010006, 4020000, 4020001, 4020002, 4020003, 4020004, 4020005, 4020006,
    1072369, 4030002, 1072369, 4030002, 1072369, 4030002, 1072369, 4030002, //特殊
    
    2040502, 2040505, 2040802, 2040002, 2040402, 2040602, //卷軸 30%
    2040502, 2040505, 2040802, 2040002, 2040402, 2040602, //卷軸 30%
    2040502, 2040505, 2040802, 2040002, 2040402, 2040602, //卷軸 30%
    1032004, 1032005, 1032009, 1032006, 1032007, 1032010, 1032002, 1002026, 1002089, 1002090, //裝備 30%
    1032004, 1032005, 1032009, 1032006, 1032007, 1032010, 1032002, 1002026, 1002089, 1002090, //裝備 30%
    2000001, 2000002, 2000003, 2000006, 2000004, 2022000, 2022003, //藥水
    2000001, 2000002, 2000003, 2000006, 2000004, 2022000, 2022003, //藥水
    2000001, 2000002, 2000003, 2000006, 2000004, 2022000, 2022003, //藥水
    4010000, 4010001, 4010002, 4010003, 4020007, 4020008, 4003000, //礦石
    4010004, 4010005, 4010006, 4020000, 4020001, 4020002, 4020003, 4020004, 4020005, 4020006,
    4030002, 4030002, 4030002, 4030002,  //特殊
    1072369, 1072369, 1072369, 1072369, 1072369, 1072369, 1072369, 1072369,
    2450115);
...
//		    cm.sendNext("Please hurry on to the next stage, the portal opened!");
                    ...
                    if (totplayers == 3 || debug) {
                        ...
                        if (testcombo || debug) {
                            // Do clear
                            clear(curMap, eim, cm);
                            var exp = (Math.pow(2, curMap-1) * 375);
...
function getPrize(eim, cm) {
    ...
    cm.removeAll(4001008);
    if(randItem ==2450115||randItem ==4030002||randItem ==1072369){
        cm.worldMessageYellowItem(gainItem, "組隊任務","被他從超級綠水靈組隊任務中取得了，大家恭喜他吧！");
    }
    cm.broadcastFinishEvent("墮落城市-超級綠水靈");
