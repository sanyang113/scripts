    ...
    if (status == 0) {
        ...
        if (selection == 0) { //ZPQ
            ...
            if (cm.getQuestStatus(100200) == 2) {
                ...
                cm.sendYesNo("你想收買我？哈哈，可以啊！但你必須給我#e#r10,000,000#n#k 楓幣，我就可以讓你直接跳過任務。");
                status = 3;
            }
        } else if (selection == 5) {
            if (cm.getQuestStatus(100200) == 2) {
                cm.sendYesNo("購買一顆 火焰之眼 需要 #e#r3,000,000#n#k 楓幣，確定要購買嗎");
                status = 4;
            } else {
                cm.sendOk("需要完成殘暴炎魔前置任務才可購買");
                cm.dispose();
            }
        }
    } else if (status == 2) {
