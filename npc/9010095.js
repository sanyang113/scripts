...
var reward = [
    { itemId: 1022150, chance: 72 },
    { itemId: 1022151, chance: 20 },
    { itemId: 1022152, chance: 5 },

    { itemId: 2435603, chance: 0.5 },
    { itemId: 2435627, chance: 0.5 },
    { itemId: 3018461, chance: 0.5 },
    { itemId: 3018462, chance: 0.5 },
    { itemId: 3018593, chance: 0.5 },
    { itemId: 1902669, chance: 0.5 },
];
    ...
    switch (status) {
        ...
        case 1:
            ...
            if (sel == 1) {
                ...
                if(item ==1022152||item ==2435603||item ==2435627||item ==3018461||item ==3018462||item ==3018593||item ==1902669){
                    cm.worldMessageYellowItem(gainItem, "萬聖舞會","被他從萬聖舞會中取得了，大家恭喜他吧！");
                }
                gain = true;
