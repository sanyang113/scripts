    ...
    if (mode == -1) {
		...
		var Editing = false //false 開始
          ...
          return;
			...
			cm.sendSimple("#b歡迎玩家 #r#h ##k 兌換黃金楓葉武器。" +
            "#k\r\n#L1##i1302064# #r+ #i4000313#x500 #b 換#i1302142#\r\n#L2##i1312032# #r+ #i4000313#x500 #b 換#i1312056#\r\n#L3##i1322054# #r+ #i4000313#x500 #b 換#i1322084#\r\n#L4##i1332055# #r+ #i4000313#x500 #b 換#i1332114#\r\n#L5##i1332056# #r+ #i4000313#x500 #b 換#i1332114#\r\n#L6##i1372034# #r+ #i4000313#x500 #b 換#i1372071#\r\n#L7##i1382039# #r+ #i4000313#x500 #b 換#i1382093#\r\n#L8##i1402039# #r+ #i4000313#x500 #b 換#i1402085#\r\n#L9##i1412027# #r+ #i4000313#x500 #b 換#i1412055#\r\n#L10##i1422029# #r+ #i4000313#x500 #b 換#i1422057#\r\n#L11##i1432040# #r+ #i4000313#x500 #b 換#i1432075#\r\n#L12##i1442051# #r+ #i4000313#x500 #b 換#i1442104#\r\n#L13##i1452045# #r+ #i4000313#x500 #b 換#i1452100#\r\n#L14##i1462040# #r+ #i4000313#x500 #b 換#i1462085#\r\n#L15##i1472055# #r+ #i4000313#x500 #b 換#i1472111#\r\n#L16##i1482022# #r+ #i4000313#x500 #b 換#i1482073#\r\n#L17##i1492022# #r+ #i4000313#x500 #b 換#i1492073#");
        } else if (status == 1) {
            ...
            if (selection == 1) {
                if (cm.haveItem(1302064, 1) && cm.haveItem(4000313, 500) ) {
                    ...
                    cm.sendOk("獲得#i1302142#x1");
                    cm.dispose();
                } else {
                    cm.sendOk("您身上沒有足夠的道具,請在次確認");
                    cm.dispose();
                }
            } else if (selection == 2) {
