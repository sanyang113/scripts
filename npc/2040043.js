                ...
                if (complete != null) {
                    ...
                    for (i = 0; i < objset.length; i++) {
                        for (j = 0; j < party.size(); j++) {
                            if(party.get(j).getMapId() == 922010800) {
                    ...
                    if (totplayers == 5 || debug) {
                        ...
                        if (debug) {
                            ...
                            cm.sendNext("It looks like you haven't found the 4 " + nthobj + " just yet. Please think of a different combination of " + nthobj + ". Only 4 are allowed to " + nthverb + " on " + nthobj + ", and if you " + nthpos + " it may not count as an answer, so please keep that in mind. Keep going!");
                            cm.dispose();
                        }
                    }
                }
