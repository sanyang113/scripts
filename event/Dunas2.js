...
function setup(eim, leaderid) {
	...
	var mob = em.getMonster(9400295); // Dunas Strong by chien
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-840, 43)); //BY chien
...
function allMonstersDead(eim) {
    if (eim.getProperty("dunas_summoned").equals("false")) {
        ...
        eim.getMapInstance(0).killMonster(9400295);   //by chien
		...
		eim.getMapInstance(0).spawnNpc(9120048, new java.awt.Point(83, 335));
    }
}
