...
function setup(level, leaderid) {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        eim.registerMonster(mob);
        eim.registerMonster(mob2);
        map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(200, 238));
        map.spawnMonsterOnGroundBelow(mob2, new java.awt.Point(1500, 238));
    }
