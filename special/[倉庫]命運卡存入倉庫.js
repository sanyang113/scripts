...
function action(mode, type, selection) {
    ...
    switch(status) {
        ...
        case 1:
            ...
            keepItem = item;
            cm.sendGetNumber("請問您要存入幾張呢？", 1, 1, item.getQuantity() > 5000 ? 5000 : item.getQuantity());
            break;
        case 2:
            var msg = cm.getDivinationStorage().addItem(cm.getPlayer(), keepItem, selection);
            if (msg != null) {
                cm.sendOk(msg);
                cm.dispose();
                return;
