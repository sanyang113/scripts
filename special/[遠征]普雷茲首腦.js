var status = -1;
var requiredLevel = 150;
var eventName = "CoreBlaze";
var squadName = "Core_Blaze";
var triggerMap = 802000800;
var maxSize = 12;
var minSize = 6;
var maxCount = 3; //場次限制
...
function start() {
    ...
    if (cm.getMapId() == triggerMap) {
        ...
        if (prop == null || prop.equals("0")) {
            ...
            var check1 = cm.getMapFactory().getMap(802000802);
            var check2 = cm.getMapFactory().getMap(802000803);
