...
function action(mode, type, selection) {
    ...
    switch(status) {
        case 0:
            ...
            break;
        case 1:
            var ret = cm.searchSkillBook(cm.getText());
            if(ret == null) {
                cm.sendOk("沒有匹配的項目唷！");
                cm.dispose();
                return;
            ...
            break;
        case 2:
            var qty = cm.getSkillBookStorage().SearchOneItem(cm.getPlayer(), selection);
            if(qty == 0) {
            ...
            sel = selection;
            var msg = "您有#b#i" + selection + ":##t" + selection + "##k 共計 " + qty + "本，請輸入提領本數：";
