...
function action(mode, type, selection) {
    ...
    switch(status) {
        case 0:
            if(cm.getPlayer().getMapId() == 802000821) {
                cm.dispose();
            ...
            var msg = "這裡是#b" + showName + "#k#d#e(遠征重製時間為每周日晚上23:59)#n#k\r\n";
            msg += "挑戰奧芙赫班需要使用 #b#i" + useItem + ":##t" + useItem + ":##k 進行擴充\r\n\r\n";
            ...
            if (cm.getQuestStatus(50020) == 2 && cm.getQuestStatus(50034) <= 1 ) {
                msg += "\r\n\r\n\r\n#L100#我想去找阿舒蕾#l"
            }
            cm.sendNext(msg);
            break;
