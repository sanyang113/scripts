...
var useItem = 4039075;
var quantity = 5;
var exchangeMessage = "龍神手套(0~3捲次、四排附魔詞)";
var note = "獲得裝備為四排附魔詞，但裝備僅有0~3捲次";
...
function doAction() {
    ...
    var equip = cm.generateEquipRandomStats(itemid).setUpgradeSlotsNew(scroll).setEnchant(4).setPollute();
    cm.buildEquip(equip);
